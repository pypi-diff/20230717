# Comparing `tmp/ipfabric_diagrams-6.3.0b0.tar.gz` & `tmp/ipfabric_diagrams-6.3.0b1.tar.gz`
...
## Comparing `ipfabric_diagrams-6.3.0b0.tar` & `ipfabric_diagrams-6.3.0b1.tar`
...
### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/__init__.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/__init__.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/__init__.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/__init__.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/graphs.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/graphs.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/icmp.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/icmp.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/input_models/__init__.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/input_models/__init__.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/input_models/constants.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/input_models/constants.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/input_models/factory_defaults/networkSettings.json` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/input_models/factory_defaults/networkSettings.json`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/input_models/factory_defaults/pathLookupSettings.json` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/input_models/factory_defaults/pathLookupSettings.json`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/input_models/graph_parameters.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/input_models/graph_parameters.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/input_models/graph_settings.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/input_models/graph_settings.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/output_models/graph_result.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/output_models/graph_result.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/output_models/protocols.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/output_models/protocols.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric/diagrams/output_models/trace.py` & `ipfabric_diagrams-6.3.0b1/ipfabric/diagrams/output_models/trace.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric_diagrams/__init__.py` & `ipfabric_diagrams-6.3.0b1/ipfabric_diagrams/__init__.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/ipfabric_diagrams/icmp.py` & `ipfabric_diagrams-6.3.0b1/ipfabric_diagrams/icmp.py`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/LICENSE` & `ipfabric_diagrams-6.3.0b1/LICENSE`

 * *Files identical despite different names*

### Comparing `ipfabric_diagrams-6.3.0b0/pyproject.toml` & `ipfabric_diagrams-6.3.0b1/pyproject.toml`
...
### Comparing `ipfabric_diagrams-6.3.0b0/README.md` & `ipfabric_diagrams-6.3.0b1/README.md`
...
### Comparing `ipfabric_diagrams-6.3.0b0/setup.py` & `ipfabric_diagrams-6.3.0b1/setup.py`
...
### Comparing `ipfabric_diagrams-6.3.0b0/PKG-INFO` & `ipfabric_diagrams-6.3.0b1/PKG-INFO`
