# Comparing `tmp/mstuff-0.7.7.tar.gz` & `tmp/mstuff-0.7.8.tar.gz`
...
## Comparing `mstuff-0.7.7.tar` & `mstuff-0.7.8.tar`
...
### Comparing `mstuff-0.7.7/mstuff/http.py` & `mstuff-0.7.8/mstuff/http.py`

 * *Files identical despite different names*

### Comparing `mstuff-0.7.7/mstuff/mstuff.py` & `mstuff-0.7.8/mstuff/mstuff.py`
