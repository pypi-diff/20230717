# Comparing `tmp/pankmer-0.13.0.tar.gz` & `tmp/pankmer-0.9.0.tar.gz`
...
## Comparing `pankmer-0.13.0.tar` & `pankmer-0.9.0.tar`

### file list

```diff
@@ -1,33 +1,34 @@
--rw-r--r--   0        0        0      588 1970-01-01 00:00:00.000000 pankmer-0.13.0/rust/Cargo.toml
--rw-r--r--   0      501       20     2446 2023-05-28 17:15:47.000000 pankmer-0.13.0/rust/src/adj_matrix.rs
--rw-r--r--   0      501       20     3544 2023-07-14 06:20:11.000000 pankmer-0.13.0/rust/src/decompose_kmers.rs
--rw-r--r--   0      501       20    11922 2023-07-17 06:11:49.000000 pankmer-0.13.0/rust/src/get_kmers.rs
--rw-r--r--   0      501       20     2864 2023-07-17 05:50:46.000000 pankmer-0.13.0/rust/src/helpers.rs
--rw-r--r--   0      501       20    10068 2023-07-17 05:50:46.000000 pankmer-0.13.0/rust/src/lib.rs
--rw-r--r--   0      501       20     3946 2023-07-17 06:11:49.000000 pankmer-0.13.0/rust/src/measure.rs
--rw-r--r--   0      501       20     2667 2023-07-14 06:20:11.000000 pankmer-0.13.0/rust/src/mem_blocks.rs
--rw-r--r--   0      501       20     4833 2023-07-17 05:50:46.000000 pankmer-0.13.0/rust/src/metadata.rs
--rw-r--r--   0      501       20    16031 2023-07-17 06:11:49.000000 pankmer-0.13.0/rust/src/pkidx.rs
--rw-r--r--   0      501       20    12197 2023-07-15 22:05:56.000000 pankmer-0.13.0/rust/src/score_list_io.rs
--rw-r--r--   0      501       20     4992 2023-07-17 05:50:46.000000 pankmer-0.13.0/rust/src/subset_index.rs
--rw-r--r--   0      501       20     1160 2023-07-17 06:11:49.000000 pankmer-0.13.0/pyproject.toml
--rw-r--r--   0      501       20    32404 2023-07-16 01:42:18.000000 pankmer-0.13.0/rust/Cargo.lock
--rw-r--r--   0      501       20     6139 2023-07-14 06:20:11.000000 pankmer-0.13.0/src/pankmer/tree.py
--rw-r--r--   0      501       20     6117 2023-07-14 06:20:11.000000 pankmer-0.13.0/src/pankmer/collect.py
--rw-r--r--   0      501       20       58 2023-05-28 17:15:47.000000 pankmer-0.13.0/src/pankmer/version.py
--rw-r--r--   0      501       20    18008 2023-07-14 06:20:11.000000 pankmer-0.13.0/src/pankmer/env.py
--rw-r--r--   0      501       20     3314 2023-05-02 11:05:38.000000 pankmer-0.13.0/src/pankmer/clustermap.py
--rw-r--r--   0      501       20      214 2023-05-19 03:56:34.000000 pankmer-0.13.0/src/pankmer/get_lower_bound.py
--rw-r--r--   0      501       20     1493 2023-02-04 07:49:15.000000 pankmer-0.13.0/src/pankmer/download.py
--rw-r--r--   0      501       20      313 2023-06-14 06:39:56.000000 pankmer-0.13.0/src/pankmer/__init__.py
--rw-r--r--   0      501       20     1795 2023-07-14 06:20:11.000000 pankmer-0.13.0/src/pankmer/adjacency_matrix.py
--rw-r--r--   0      501       20     2233 2023-07-14 06:20:11.000000 pankmer-0.13.0/src/pankmer/upset.py
--rw-r--r--   0      501       20      603 2023-07-17 05:50:46.000000 pankmer-0.13.0/src/pankmer/subset.py
--rw-r--r--   0      501       20      947 2023-07-14 06:20:11.000000 pankmer-0.13.0/src/pankmer/gzip_agnostic_open.py
--rw-r--r--   0      501       20    18604 2023-07-14 04:48:52.000000 pankmer-0.13.0/src/pankmer/reg_coverage.py
--rw-r--r--   0      501       20     3284 2023-07-14 06:20:11.000000 pankmer-0.13.0/src/pankmer/anchormap.py
--rw-r--r--   0      501       20      757 2023-05-28 17:15:47.000000 pankmer-0.13.0/src/pankmer/count.py
--rw-r--r--   0      501       20     2273 2023-07-15 22:02:59.000000 pankmer-0.13.0/src/pankmer/dryrun.py
--rw-r--r--   0      501       20    64311 2023-07-17 06:11:49.000000 pankmer-0.13.0/src/pankmer/pankmer.py
--rw-r--r--   0      501       20     4321 2023-07-17 06:11:49.000000 pankmer-0.13.0/README.md
--rw-r--r--   0        0        0     5332 1970-01-01 00:00:00.000000 pankmer-0.13.0/PKG-INFO
...
### Comparing `pankmer-0.13.0/pyproject.toml` & `pankmer-0.9.0/pyproject.toml`
...
+build-backend = "setuptools.build_meta"
 ...
 [project]
 name = "pankmer"
-version = "0.13.0" # Don't forget to match with Cargo.toml and docs/source/conf.py
...
### Comparing `pankmer-0.13.0/src/pankmer/tree.py` & `pankmer-0.9.0/src/pankmer/tree.py`
...
### Comparing `pankmer-0.13.0/src/pankmer/env.py` & `pankmer-0.9.0/src/pankmer/env.py`
...
### Comparing `pankmer-0.13.0/src/pankmer/clustermap.py` & `pankmer-0.9.0/src/pankmer/clustermap.py`
...
### Comparing `pankmer-0.13.0/src/pankmer/download.py` & `pankmer-0.9.0/src/pankmer/download.py`

 * *Files identical despite different names*

### Comparing `pankmer-0.13.0/src/pankmer/adjacency_matrix.py` & `pankmer-0.9.0/src/pankmer/adjacency_matrix.py`
...
### Comparing `pankmer-0.13.0/src/pankmer/reg_coverage.py` & `pankmer-0.9.0/src/pankmer/reg_coverage.py`
...
### Comparing `pankmer-0.13.0/src/pankmer/count.py` & `pankmer-0.9.0/src/pankmer/count.py`
...
### Comparing `pankmer-0.13.0/src/pankmer/pankmer.py` & `pankmer-0.9.0/src/pankmer/pankmer.py`
...
-#===============================================================================
-KMER_MAX = 2**64 - 1
-SEQ_EXTENSIONS = (".fasta.gz", ".fna.gz", ".fa.gz", ".fastq.gz", ".fq.gz",
-                ".fasta", ".fna", ".fa", ".fastq", ".fq")
-
-#===============================================================================
...
-                               for ((g0, s0), (g1, s1))
-                               in batched(measure_genomes(genomes_paired, '').items(), 2)}
-    else:
...
### Comparing `pankmer-0.13.0/README.md` & `pankmer-0.9.0/README.md`
...
### Comparing `pankmer-0.13.0/PKG-INFO` & `pankmer-0.9.0/PKG-INFO`
