# Comparing `tmp/IMSmartFinderNinja-0.0.8.tar.gz` & `tmp/IMSmartFinderNinja-0.0.9.tar.gz`
...
## Comparing `IMSmartFinderNinja-0.0.8.tar` & `IMSmartFinderNinja-0.0.9.tar`
...
### Comparing `IMSmartFinderNinja-0.0.8/PKG-INFO` & `IMSmartFinderNinja-0.0.9/PKG-INFO`
...
### Comparing `IMSmartFinderNinja-0.0.8/setup.cfg` & `IMSmartFinderNinja-0.0.9/setup.cfg`
...
### Comparing `IMSmartFinderNinja-0.0.8/src/IMSmartFinderNinja.egg-info/PKG-INFO` & `IMSmartFinderNinja-0.0.9/src/IMSmartFinderNinja.egg-info/PKG-INFO`
...
### Comparing `IMSmartFinderNinja-0.0.8/src/Ninja/Ninja_Finder.py` & `IMSmartFinderNinja-0.0.9/src/Ninja/Ninja_Finder.py`
