# Comparing `tmp/global_tonemapping-0.1.0.tar.gz` & `tmp/global_tonemapping-0.1.1.tar.gz`
...
+gzip compressed data, was "global_tonemapping-0.1.1.tar", last modified: Mon Jul 17 18:36:37 2023, max compression
```

## Comparing `global_tonemapping-0.1.0.tar` & `global_tonemapping-0.1.1.tar`
...
+drwxrwxrwx   0        0        0        0 2023-07-17 18:36:37.464788 global_tonemapping-0.1.1/
+-rw-rw-rw-   0        0        0      212 2023-07-17 18:36:37.464788 global_tonemapping-0.1.1/PKG-INFO
+-rw-rw-rw-   0        0        0        0 2023-07-15 11:18:12.000000 global_tonemapping-0.1.1/README.md
+drwxrwxrwx   0        0        0        0 2023-07-17 18:36:37.464788 global_tonemapping-0.1.1/global_tonemapping.egg-info/
+-rw-rw-rw-   0        0        0      212 2023-07-17 18:36:37.000000 global_tonemapping-0.1.1/global_tonemapping.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      379 2023-07-17 18:36:37.000000 global_tonemapping-0.1.1/global_tonemapping.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-07-17 18:36:37.000000 global_tonemapping-0.1.1/global_tonemapping.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       13 2023-07-17 18:36:37.000000 global_tonemapping-0.1.1/global_tonemapping.egg-info/requires.txt
+-rw-rw-rw-   0        0        0        1 2023-07-17 18:36:37.000000 global_tonemapping-0.1.1/global_tonemapping.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2023-07-17 18:36:37.464788 global_tonemapping-0.1.1/setup.cfg
+-rw-rw-rw-   0        0        0      392 2023-07-17 18:36:18.000000 global_tonemapping-0.1.1/setup.py
+drwxrwxrwx   0        0        0        0 2023-07-17 18:36:37.464788 global_tonemapping-0.1.1/tests/
+-rw-rw-rw-   0        0        0      767 2023-07-17 18:33:06.000000 global_tonemapping-0.1.1/tests/test_crf_calc.py
+-rw-rw-rw-   0        0        0     1090 2023-07-15 11:54:54.000000 global_tonemapping-0.1.1/tests/test_crfio.py
+-rw-rw-rw-   0        0        0      828 2023-07-17 18:18:55.000000 global_tonemapping-0.1.1/tests/test_merging.py
+-rw-rw-rw-   0        0        0     2532 2023-07-17 18:27:43.000000 global_tonemapping-0.1.1/tests/test_processor.py
+-rw-rw-rw-   0        0        0      667 2023-07-15 19:23:54.000000 global_tonemapping-0.1.1/tests/test_sharpen.py
+-rw-rw-rw-   0        0        0      840 2023-07-17 18:11:51.000000 global_tonemapping-0.1.1/tests/test_suit.py
+-rw-rw-rw-   0        0        0      606 2023-07-17 18:19:08.000000 global_tonemapping-0.1.1/tests/test_tonemap.py
```

### Comparing `global_tonemapping-0.1.0/tests/test_crfio.py` & `global_tonemapping-0.1.1/tests/test_crfio.py`

 * *Files identical despite different names*

### Comparing `global_tonemapping-0.1.0/tests/test_merging.py` & `global_tonemapping-0.1.1/tests/test_merging.py`
...
### Comparing `global_tonemapping-0.1.0/tests/test_processor.py` & `global_tonemapping-0.1.1/tests/test_processor.py`
...
### Comparing `global_tonemapping-0.1.0/tests/test_sharpen.py` & `global_tonemapping-0.1.1/tests/test_sharpen.py`

 * *Files identical despite different names*

### Comparing `global_tonemapping-0.1.0/tests/test_tonemap.py` & `global_tonemapping-0.1.1/tests/test_tonemap.py`
