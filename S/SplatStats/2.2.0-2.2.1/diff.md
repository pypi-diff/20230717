# Comparing `tmp/SplatStats-2.2.0.tar.gz` & `tmp/SplatStats-2.2.1.tar.gz`
...
### Comparing `SplatStats-2.2.0/SplatStats/Battle.py` & `SplatStats-2.2.1/SplatStats/Battle.py`
