# Comparing `tmp/rapid_table-0.1.1-py3-none-any.whl.zip` & `tmp/rapid_table-3.6-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,17 +1,17 @@
-Zip file size: 7077779 bytes, number of entries: 15
--rw-r--r--  2.0 unx      110 b- defN 23-Jul-17 08:59 rapid_table/__init__.py
--rw-r--r--  2.0 unx     3789 b- defN 23-Jul-17 08:59 rapid_table/rapid_table.py
--rw-r--r--  2.0 unx     2701 b- defN 23-Jul-17 08:59 rapid_table/utils.py
...
--rw-r--r--  2.0 unx      106 b- defN 23-Jul-17 08:59 rapid_table/table_matcher/__init__.py
--rw-r--r--  2.0 unx     4760 b- defN 23-Jul-17 08:59 rapid_table/table_matcher/matcher.py
--rw-r--r--  2.0 unx     9671 b- defN 23-Jul-17 08:59 rapid_table/table_matcher/utils.py
--rw-r--r--  2.0 unx      653 b- defN 23-Jul-17 08:59 rapid_table/table_structure/__init__.py
--rw-r--r--  2.0 unx     1933 b- defN 23-Jul-17 08:59 rapid_table/table_structure/table_structure.py
--rw-r--r--  2.0 unx    11920 b- defN 23-Jul-17 08:59 rapid_table/table_structure/utils.py
--rw-r--r--  2.0 unx     5742 b- defN 23-Jul-17 08:59 rapid_table-0.1.1.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 23-Jul-17 08:59 rapid_table-0.1.1.dist-info/WHEEL
--rw-r--r--  2.0 unx       61 b- defN 23-Jul-17 08:59 rapid_table-0.1.1.dist-info/entry_points.txt
--rw-r--r--  2.0 unx       12 b- defN 23-Jul-17 08:59 rapid_table-0.1.1.dist-info/top_level.txt
--rw-rw-r--  2.0 unx     1336 b- defN 23-Jul-17 08:59 rapid_table-0.1.1.dist-info/RECORD
-15 files, 7747295 bytes uncompressed, 7075537 bytes compressed:  8.7%
...
-Filename: rapid_table-0.1.1.dist-info/METADATA
+Filename: rapid_table-3.6.dist-info/METADATA
 Comment: 
 
-Filename: rapid_table-0.1.1.dist-info/WHEEL
+Filename: rapid_table-3.6.dist-info/WHEEL
 Comment: 
 
-Filename: rapid_table-0.1.1.dist-info/entry_points.txt
+Filename: rapid_table-3.6.dist-info/entry_points.txt
 Comment: 
 
-Filename: rapid_table-0.1.1.dist-info/top_level.txt
+Filename: rapid_table-3.6.dist-info/top_level.txt
 Comment: 
 
-Filename: rapid_table-0.1.1.dist-info/RECORD
...
## Comparing `rapid_table-0.1.1.dist-info/METADATA` & `rapid_table-3.6.dist-info/METADATA`
...
```diff
@@ -1,43 +1,34 @@
-Metadata-Version: 2.1 Name: rapid-table Version: 0.1.1 Summary: Tools for
...
-command line. - Usage: ```bash $ rapid_table -h usage: rapid_table [-h] [-v] -
-img IMG_PATH [-m MODEL_PATH] optional arguments: -h, --help show this help
-message and exit -v, --vis Wheter to visualize the layout results. -img
-IMG_PATH, --img_path IMG_PATH Path to image for layout. -m MODEL_PATH, --
-model_path MODEL_PATH The model path used for inference. ``` - Example: ```bash
-$ rapid_table -v -img test_images/table.jpg ``` ### 4. Result. - Return value.
-```html
+RapidAI/RapidStructure/blob/main/test_images/table.jpg) ```python from
...
-### For details, see [Rapid Table](https://github.com/RapidAI/RapidStructure/
-blob/main/docs/README_Table.md)
```

## Comparing `rapid_table-0.1.1.dist-info/RECORD` & `rapid_table-3.6.dist-info/RECORD`
...
-rapid_table-0.1.1.dist-info/METADATA,sha256=vAh3pTQ4sTLkiaAWMqW2TIlFV6oC288Id-Xq6U_gmZ8,5742
-rapid_table-0.1.1.dist-info/WHEEL,sha256=pkctZYzUS4AYVn6dJ-7367OJZivF2e8RA9b_ZBjif18,92
-rapid_table-0.1.1.dist-info/entry_points.txt,sha256=a4UsMSxd7Ex1mZvdIT5AmkuiUAvB__awLj-NeYU8bsQ,61
-rapid_table-0.1.1.dist-info/top_level.txt,sha256=DkBPZpaze8SaoAvCufxilNpITY4n-rHH1lgHr6KHPgA,12
-rapid_table-0.1.1.dist-info/RECORD,,
