# Comparing `tmp/wipac-keycloak-rest-services-1.4.7.tar.gz` & `tmp/wipac-keycloak-rest-services-1.4.8.tar.gz`
...
### Comparing `wipac-keycloak-rest-services-1.4.7/LICENSE` & `wipac-keycloak-rest-services-1.4.8/LICENSE`
